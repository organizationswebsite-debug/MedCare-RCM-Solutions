    ...
    <>
      ...
      <main style={{ backgroundColor: "#F5F0E8", overflowX: "hidden" }}>
        ...
        >
          ...
          <div style={{
            maxWidth: 800, margin: "0 auto", position: "relative", zIndex: 2,
            opacity: mounted ? 1 : 0,
            ...
            <p style={{ fontSize: "clamp(16px,2vw,18px)", color: "#555555", lineHeight: 1.7, maxWidth: 650, margin: "0 auto 32px", fontWeight: 500 }}>
            ...
            {/* Rating pills */}
            <div className="hero-pills" style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 14, flexWrap: "wrap" }}>
